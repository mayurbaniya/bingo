...
public class MailTemplates {
    ...
    public boolean sendGanapatiRegistrationEmail(EntryForm entryForm) {
        ...
        String body = "<html>" +
                ...
                "<div class='hero'>" +
                "<img src='https://upload.wikimedia.org/wikipedia/commons/3/33/Ganesh_icon.png' alt='Ganapati Logo' style='height: 60px; margin-bottom: 20px;'>"
                +
    ...
    public boolean sendPaymentConfirmationEmail1(EntryForm entryForm) {
        try{
        String subject = "✅ Payment Confirmed | Ganapati Housie Festival";

        String body = "<html>" +
                "<head>" +
                "<style>" +
                "   .hero {background: linear-gradient(135deg, #27ae60 0%, #2ecc71 100%); padding: 30px; text-align: center;}"
                +
                "   .cta-button {background-color: #f39c12; color: white; padding: 12px 25px; border-radius: 25px; text-decoration: none; display: inline-block; font-weight: bold;}"
                +
                ...
                "<body style='font-family: Arial, sans-serif; line-height: 1.6; margin: 0;'>" +
                "<div class='hero'>" +
                "<img src='https://bingo-production-23d7.up.railway.app/gallery/ganpatiheader.png' alt='Ganapati Logo' style='height: 60px; margin-bottom: 20px;'>"
                +
                "<h1 style='color: white; margin: 0; font-size: 28px;'>🎉 Payment Confirmed, " + entryForm.getName()
                + "!</h1>" +
                "<p style='color: #ecf0f1; font-size: 20px; margin: 10px 0 0;'>You’re officially part of the festival night 🎊</p>"
                +
                "</div>" +
                "<div style='padding: 30px 20px;'>" +
                "<div style='text-align: center; margin: 20px 0;'>" +
                "<div style='font-size: 50px; color: #27ae60; margin-bottom: 15px;'>💳</div>" +
                "<p style='font-size: 18px; color: #2c3e50;'>Your payment has been verified and confirmed. See you at the event!</p>"
                +
                "</div>" +
                "<div style='background: #f8f9fa; border-radius: 15px; padding: 20px; margin: 25px 0;'>" +
                "<h3 style='color: #27ae60; margin-top: 0;'>📍 Registration Summary:</h3>" +
                "<ul style='columns: 2; list-style: none; padding: 0;'>" +
                "<li style='margin-bottom: 8px;'>👤 Name: " + entryForm.getName() + "</li>" +
                "<li style='margin-bottom: 8px;'>📱 Phone: " + entryForm.getPhone() + "</li>" +
                "<li style='margin-bottom: 8px;'>📧 Email: " + entryForm.getEmail() + "</li>" +
                ...
                "<div style='text-align: center; margin-top: 15px;'>" +
                "<a class='cta-button' href='https://maps.google.com'>View Location</a>" +
                "</div>" +
                "</div>" +
                "<div style='border-top: 3px solid #27ae60; margin: 30px 0; padding-top: 20px; text-align: center;'>" +
                "<p style='margin: 0; font-size: 14px; color: #7f8c8d;'>Keep this mail handy for entry ✅</p>" +
        ...
        ByteArrayOutputStream ticketPdf = GanpatiTicketGenerator.generateTicket(entryForm);
        // Always CC admin
        return emailService.sendMIMEMail(
            entryForm.getEmail(),
            subject,
            body, false
        );
    ...
    try {
        ...
        String subject = "✅ Your Ganapati Festival Pass & Payment Confirmation";
        ...
        String body = "<html>" +
                        ...
                        "<div style='text-align: center; margin: 20px 0;'>" +
                        "<div style='font-size: 50px; color: #27ae60; margin-bottom: 15px;'>🎫</div>" +
                        "<p style='font-size: 18px; color: #2c3e50;'>Your payment has been verified and confirmed. Your festival pass is attached!</p>" +
                        "</div>" +
                        ...
                        "<div style='background: #f8f9fa; border-radius: 15px; padding: 20px; margin: 25px 0;'>" +
                        "<h3 style='color: #ff6600; margin-top: 0;'>📍 Registration Summary:</h3>" +
                        "<ul style='columns: 2; list-style: none; padding: 0;'>" +
                        "<li style='margin-bottom: 8px;'>👤 Name: " + entryForm.getName() + "</li>" +
                        "<li style='margin-bottom: 8px;'>📱 Phone: " + entryForm.getPhone() + "</li>" +
                        "<li style='margin-bottom: 8px;'>📧 Email: " + entryForm.getEmail() + "</li>" +
